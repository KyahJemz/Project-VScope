...
const Layout = (param) => {
    ...
    if (param.params.department !== "Medical" && param.params.department !== "Dental" && param.params.department !== "SDPC") {
        router.push("/login/administrator/dashboard/Medical");
    }
    return ( 
        <div className={styles.mainContainer}>
            <div className={styles.MiniNav}>  
                <div className={styles.MiniNavTop}>
                    <select className={styles.DepartmentSelection} name="" id="" defaultValue={Department} onChange={(e)=>router.push("/login/administrator/dashboard/"+e.target.value)}>
