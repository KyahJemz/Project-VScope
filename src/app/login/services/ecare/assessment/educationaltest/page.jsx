...
const Page = () => {
  ...
  useEffect(() => {
    ...
    const defaultType = "Educational Test";
  
    const originalQuestions = AssessmentQuestions[defaultDepartment][defaultType]["Set 1"];
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('Department', 'SDPC');
    formData.append('GoogleImage', GoogleImage);
    formData.append('Type', 'Educational Test');
    formData.append('Set', 'Set 1');
    formData.append('Questions', JSON.stringify(shuffledQuestions.map((question, index) => AssessmentQuestions["SDPC"]["Educational Test"]["Set 1"].indexOf(question)))); 
  ...
  return (
    <div className={styles.MainContainer}>
      <div className={styles.Header}>Educational Test</div>
