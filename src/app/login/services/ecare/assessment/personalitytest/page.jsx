...
const Page = () => {
  ...
  useEffect(() => {
    ...
    const defaultType = "Personality Test";
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('Type', 'Personality Test');
    formData.append('Set', 'Set 1');
    formData.append('Questions', JSON.stringify(shuffledQuestions.map((question, index) => AssessmentQuestions["SDPC"]["Personality Test"]["Set 1"].indexOf(question)))); 
  ...
  return (
    <div className={styles.MainContainer}>
      <div className={styles.Header}>Personality Test</div>
